...
char *conjugateVerbImperfectFirstConjugation(struct Conjugation conjugation) {
    char *stem = getStemOfVerbImperfect(conjugation);
    char *conjugatedVerb;
...
char *conjugateVerbImperfectThirdConjugation(struct Conjugation conjugation) {
    char *stem = getStemOfVerbImperfect(conjugation);
    char *conjugatedVerb;
    if (isThirdConjugation(conjugation)) {
        switch (conjugation.Number) {
...
char *conjugateVerbImperfectFourthConjugation(struct Conjugation conjugation) {
    char *stem = getStemOfVerbImperfect(conjugation);
    char *conjugatedVerb;
    if (isFourthConjugation(conjugation)) {
        switch (conjugation.Number) {
